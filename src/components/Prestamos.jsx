...
import{listarPrestamos, registrarPrestamo, prestamosPorUsuario} from "../services/prestamoService";
...
function Prestamos(){
    ...
    const cargarPrestamos = async () => {
        try{
            ...
            setError("No se pudieron cargar los prestamos");
        }
    };
    ...
    const regitrar = async (e) =>{
        ...
        try{
            ...
            setError("Error: " + (err.response?.data?.message || "no se pudo registrar el prestamo"));
        }
    };
    ...
    const filtrar = async (e) => {
        ...
        try{
            const res = await prestamosPorUsuario(filtroUsuario);
            setPrestamos(res.data);
        }catch(err){
            setError("No se pudieron filtrar los prestamos");
        }
    };
